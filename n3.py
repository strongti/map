...
<head>
    ...
    #roadviewControl {position:absolute;top:5px;left:90%;width:42px;height:42px;z-index: 1;cursor: pointer; background: url(https://t1.daumcdn.net/localimg/localimages/07/2018/pc/common/img_search.png) 0 -450px no-repeat;}
...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=47d55a4d07d8d800b2c3a9894c6c5bea&libraries=services"></script>
<script>
var markers = [];
...
def run():
    #prepare_view()
    prepare_picker()
    httpd = HTTPServer(('127.0.0.1', 8081), RequestHandler)
    httpd.serve_forever()